...
export const GradientBg = ({ className }) => {
  return (
    <svg
    ...
    >
      <g className="g" clipPath="url(#clip0_101_7537)">
        <g className="g" filter="url(#filter0_f_101_7537)" opacity="0.32">
      ...
      <defs className="defs">
        ...
        >
          ...
          <feGaussianBlur className="fe-gaussian-blur" result="effect1_foregroundBlur_101_7537" stdDeviation="250" />
        </filter>
        <clipPath className="clip-path" id="clip0_101_7537">
