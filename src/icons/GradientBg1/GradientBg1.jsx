  ...
  return (
    ...
    >
      <g className="g" clipPath="url(#clip0_101_7599)">
        <g className="g" filter="url(#filter0_f_101_7599)" opacity="0.32">
          <rect className="rect" fill="#5169BE" height="329.143" rx="14" width="329.143" x="379.857" y="66.0391" />
          <rect className="rect" fill="#FF5A5A" height="329.143" rx="77" width="329.143" x="-315" y="66.0391" />
          <path
            className="path"
            d="M148.702 93.724C170.168 56.8108 223.832 56.8108 245.298 93.724L372.302 312.127C393.768 349.04 366.936 395.182 324.005 395.182H69.9952C27.0641 395.182 0.232102 349.04 21.6977 312.127L148.702 93.724Z"
            fill="#00A4E4"
          />
        </g>
      </g>
